...
GOOGLE_API_KEY = os.environ.get("GOOGLE_API_KEY", "google-api")
...
OPENWEATHERMAP_API_KEY = os.environ.get("OPENWEATHERMAP_API_KEY", "open-weather-api")
GNEWS_API_KEY = os.environ.get("GNEWS_API_KEY", "gnews-api")
